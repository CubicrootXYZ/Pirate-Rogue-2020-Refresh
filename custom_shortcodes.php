...
function topicrect_func($atts, $content = null) {
    ...
    return "<div onclick='location.href=\"".$url."\";' style='background-image: url(\"".$image."\"); min-width:".$width.";' class='topicrect'><div class='topicrect-title'>".$title."</div><div class='topicrect-content'>".$content."</div></div>";
}
